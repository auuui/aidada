package com.yupi.aidada.service.impl;
...
import com.yupi.aidada.constant.CommonConstant;
import com.yupi.aidada.exception.ThrowUtils;
import com.yupi.aidada.mapper.AppMapper;
import com.yupi.aidada.model.dto.app.AppQueryRequest;
import com.yupi.aidada.model.entity.App;
import com.yupi.aidada.model.entity.User;
import com.yupi.aidada.model.enums.AppScoringStrategyEnum;
import com.yupi.aidada.model.enums.AppTypeEnum;
import com.yupi.aidada.model.enums.ReviewStatusEnum;
import com.yupi.aidada.model.vo.AppVO;
...
import com.yupi.aidada.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        if (StringUtils.isNotBlank(searchText)) {
            // 需要拼接查询条件
            queryWrapper.and(qw -> qw.like("appName", searchText).or().like("content", searchText));
        }
        // 模糊查询
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(scoringStrategy), "appType", appType);
